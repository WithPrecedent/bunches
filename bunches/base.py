...
Contents:
    Bunch (Collection, ABC): base class for general containers in bunches. It 
        requires subclasses to have 'add', 'delete', and 'subset' methods.
    Composite (ABC): base class for bunches composite data structures. Requires 
...
class Bunch(Collection, abc.ABC): # type: ignore
    """Base class for general bunches collections.
